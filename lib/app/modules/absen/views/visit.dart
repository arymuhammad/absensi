...
//           return Visibility(
//             visible:
//                 absC.optVisitSelected.value == "Store Visit" ? true : false,
//             child: FutureBuilder(
...
//           absC.optVisitSelected.value == "Research and Development" &&
//               absC.rndLoc.text == "") {
//         dialogMsg('Info', 'Harap pilih & isi lokasi\nVisit/ RnD terlebih dulu');
//         absC.optVisitSelected.value = "";
//       } else {
//         // var paramVisitToday = {
//         //   "mode": "single",
...
//                   absC.distanceStore.value > num.parse(dataUser.areaCover!)) {
...
//               } else {
//                 if (tempDataVisit.isNotEmpty) {
//                   //old statement if ditambah && tempDataVisit.first.jamOut == ""
