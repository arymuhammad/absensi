              ...
              Obx(
                ...
                //   children: [
                    SizedBox(
                      ...
                      child: CsDropDown(
                        value:
                            ctrl.selectedstatusOvr.isNotEmpty
                                ? ctrl.selectedstatusOvr.value
                                : null,
                        items:
                            ctrl.statusReqOvr.map((e) {
                        ...
                        onChanged: (val) {
                          ...
                          ctrl.selectedstatusOvr.value = val;
              ...
              Row(
                ...
                children: [
                  ...
                  CsElevatedButtonIcon(
                    ...
                    label: 'Cari',
                    onPressed: () {
                      if (ctrl.date1.text.isEmpty || ctrl.date2.text.isEmpty) {
                        showToast(
                        ...
                        var tglA = DateFormat(
                          'yyyy-MM-dd',
                        ).format(DateTime.parse(ctrl.date1.text));
                        var tglB = DateFormat(
                          'yyyy-MM-dd',
                        ).format(DateTime.parse(ctrl.date2.text));
