...
import '../expanded_data_absen.dart';
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    if (ctrl.target.value == "absen") {
                      if (ctrl.date1.text == "" ||
                        ...
                        await ctrl.getDataAbsen(ctrl.selectedUserCabang.value);
                      }
                    } else {
                      if (ctrl.date1.text == "" ||
                  ...
                  label: const Text('CARI', style: TextStyle(fontSize: 18)),
                ),
              ],
            ),
                              ...
                              return TypeAheadFormField<String>(
                                textFieldConfiguration: TextFieldConfiguration(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: Obx(
                                      () =>
                                          ctrl.selectedUserCabang.isNotEmpty
                                              ? IconButton(
                                                onPressed: () {
                                                  ctrl
                                                      .selectedUserCabang
                              ...
                              return TypeAheadFormField<String>(
                                textFieldConfiguration: TextFieldConfiguration(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: Obx(
                                      () =>
                                          ctrl.selectedUserDept.isNotEmpty
                                              ? IconButton(
                                                onPressed: () {
                                                  ctrl.selectedUserDept.value =
                                                      "";
